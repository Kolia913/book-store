    ...
    <label class="block relative">
      ...
      >
        ...
        <svg
            ...
            class="fill-current"
        >
          <path d="M21.986 28.667c-3.75 0-7.403-2.217-9.774-5.929a1.334 1.334 0 0 1 .024-1.479c2.667-3.822 6.128-5.926 9.75-5.926 3.728 0 7.392 2.221 9.8 5.94a1.343 1.343 0 0 1 .002 1.453c-2.375 3.719-6.039 5.941-9.802 5.941zm0-12.001c-3.173 0-6.246 1.901-8.654 5.354 2.129 3.328 5.362 5.313 8.654 5.313 3.304 0 6.549-1.992 8.678-5.326-2.159-3.347-5.405-5.341-8.678-5.341z"/><path d="M22 26c-2.206 0-4-1.794-4-4s1.794-4 4-4 4 1.794 4 4-1.794 4-4 4zm0-6.667A2.67 2.67 0 0 0 19.333 22 2.67 2.67 0 0 0 22 24.667 2.67 2.67 0 0 0 24.667 22 2.67 2.67 0 0 0 22 19.333z"/>
        </svg>
      </span>
    </label>
    <span 
      v-if="error"
      class="block text-xs text-red-600 dark:text-red-500 pt-2"
    >{{ errorMessage }}</span>
  </div>
</template>
<script setup>
