<template>
    ...
    >
      <div class="flex flex-col lg:flex-row gap-12 items-center">
        ...
        <div class="w-full 2xl:w-3/4  self-start xl:self-center">
        ...
        <div class="flex w-full flex-col md:flex-row 2xl:flex-col gap-8 xl:gap-10 2xl:gap-4">
          <div class="w-full xl:w-[420px] 2xl:w-[380px] self-end">
            <div class="flex items-center justify-between pb-2">
              <span v-if="eventData.tickets_available" class="text-lg italic"
                >Квитки є в наявності</span
              >
              <span v-else class="text-lg italic text-primary-red"
                >Всі квитки розпродані</span
              >
            </div>
            <AtomsAppOutlinedButton
              ...
              :class="{
                'bg-gray-300 text-gray-500 cursor-not-allowed	pointer-events-none': !eventData.tickets_available,
              }"
            />
